...
public class MemberDto {
	...
	public int getUserRecvNotiFlag() {
		return userRecvNotiFlag;
	}
	public void setUserRecvNotiFlag(int userRecvNotiFlag) {
		this.userRecvNotiFlag = userRecvNotiFlag;
	}
	...
	public int getUserSavePoint() {
		return userSavePoint;
	}
	public void setUserSavePoint(int userSavePoint) {
