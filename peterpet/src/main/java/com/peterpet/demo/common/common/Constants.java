package com.peterpet.demo.common.common;

public class Constants {

	public static final String ADMIN_URI_CONTAINS_TEXT = "Xdm";
	public static final String PETER_URI_CONTAINS_TEXT = "Peter";
	
	public static final String SESSION_ATTR_SEQ = "sessSeqXdm";
	public static final String SESSION_PETER_SEQ = "sessSeqPeter";
